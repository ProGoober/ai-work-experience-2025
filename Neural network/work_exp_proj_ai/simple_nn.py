...
class SimpleNet(object):
    ...
    of N, a hidden layer dimension of H, and performs classification over
    C classes. The network is trained with a softmax loss function and L2
    ...
    def loss(self, X, y=None, reg=0.0):
        ...
        # both the data loss and L2 regularisation for W1 and W2. Store the result  #
